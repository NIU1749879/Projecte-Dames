...
int main(int argc, const char* argv[])
{
    ...
    // Tria el mode (normal o replay) i els noms de fitxer
    ModeJoc mode = MODE_JOC_REPLAY;
    const std::string fitxerTauler = "data/Games/tauler_inicial.txt";
    const std::string fitxerMoviments = "data/Games/moviments.txt";
